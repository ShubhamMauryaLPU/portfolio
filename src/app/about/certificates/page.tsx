    ...
    <div className="min-h-screen bg-black py-12 pt-36">
      ...
      <div className="flex flex-wrap justify-center">
        {certificate.map((cert, idx) => (
          <CardContainer
            key={cert._id || idx}
            className="inter-var mx-4"
          >
            <CardBody
              className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] 
                border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-4 lg:p-6 border"
            >
              ...
              <div className="mt-4">
                ...
                >
                  {cert.from}
                  <span className="float-right">{cert.Grade}</span>
                </CardItem>
              </div>
            </CardBody>
          </CardContainer>
