    ...
    <div className="mt-40 w-[90%] mx-auto">
      <div className="  relative">
        ...
        <div className="relative shadow-xl bg-gray-900 border border-gray-800  px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
          <h1 className="font-bold text-xl text-white mb-4 relative z-50 w-full block">
          Filmen | Movie Website Using Pure React <span className=" float-right"> 22 Jul'24</span>
          </h1>
          ...
          <ul className="text-base text-slate-250 mb-4 relative z-50 list-disc pl-3">
        ...
        <div className="relative shadow-xl mt-4 bg-gray-900 border border-gray-800  px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
          <h1 className="font-bold text-xl text-white mb-4 relative z-50 w-full block">
          Zerodha Clone | Commerce Website Using React <span className=" float-right"> 5 Oct'24</span>
          </h1>
          <p className="font-normal text-base text-slate-400 mb-4 relative z-50">
            <b>Technologies Used: React, Redux, Bootstrap, Node.js, Express, MongoDB</b>
          </p>
          ...
          <button className="border px-4 py-1 rounded-lg  border-gray-500 text-gray-300">
            <a href="https://filmen2.onrender.com/">Zerodha</a>
          </button>
          <Meteors number={20} />
        </div>
        <div className="relative shadow-xl mt-4 bg-gray-900 border border-gray-800  px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
          <h1 className="font-bold text-xl text-white mb-4 relative z-50 w-full block">
          Portfolio | Website Using Next Js <span className=" float-right"> 26 Dec'24</span>
          </h1>
          <p className="font-normal text-base text-slate-400 mb-4 relative z-50">
          ...
          <ul className="text-base text-slate-250 mb-4 relative z-50 list-disc pl-3">
            ...
            <li>Implemented Aceternity  UI components with JavaScript to enhance user experience.</li>
